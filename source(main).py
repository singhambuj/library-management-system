...
class Library:
    ...
    def __init__(self,root):
        ...
        def iDisplayData():
            ...
            self.txtDisplayR.insert(END,MType.get()+ "\t"+ Ref.get() + "\t"+ Title.get() +"\t" +
            Firstname.get() + "\t" + LastName.get() + "\t" + Address1.get() +"\t\t" + Address2.get() +"\t" +
            PinCode.get() + "\t"+ BookTitle.get() + "\t\t" +DateOfIssue.get() +"\t\t" + DaysOnLoan.get() + "\n" )
        ...
        self.lblTitle = Label(TitleFrame,width=39,font=('arial',40,'bold'),text="\tLIBRARY MANAGMENT SYSTEM\t",padx=12,background='Blue')
        self.lblTitle.grid()
        ...
        DataFrameLEFT =LabelFrame(DataFrame, bd=10, width=800, height=300, padx=20, relief=RIDGE
                                , font=('arial', 12,'bold'), text="Library Membership Info:",background='DARK GREEN')
        ...
        self.cboMemberType['value']=('','Student','Lecturer','Admin (Ambuj Singh/MD. Mobashir)')
        ...
        def SelectedBook(evt):
            ...
            if (w == "Let us C"):
               ...
               Author.set("Yashavant Kanetkar")

               LateReturnFine.set("Rs.5")
               SellingPrice.set("Rs. 1000")
               DaysOnLoan.set(15)
               iReceipt()
               import datetime
       ...
       #=====================================================================
        ...
        text="Member Type \tReference No. \tFirstname \tLast Name \tAddress 1 \tAddress 2 \tPin Code \tBook Title \tDate\t Issued \tDays On Loan",)
        ...
        self.btnDisplayData=Button(ButtonFrame, text='Display Data', font=('arial',12,'bold'), width=30, bd=4, command=iDisplayData,background='DARK RED')
        self.btnDisplayData.grid(row=0, column=0)

        self.btnDelete=Button(ButtonFrame, text='Delete', font=('arial',12,'bold'), width=30, bd=4, command=iDelete,background='DARK BLUE')
        self.btnDelete.grid(row=0, column=1)

        self.btnReset=Button(ButtonFrame, text='Reset', font=('arial',12,'bold'), width=30, bd=4, command=iReset,background='DARK GREEN')
        self.btnReset.grid(row=0, column=2)

        self.btnExit=Button(ButtonFrame, text='Exit', font=('arial',12,'bold'), width=30, bd=4, command=iEXIT,background='YELLOW')
